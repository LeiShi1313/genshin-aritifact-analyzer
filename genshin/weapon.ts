...
export enum Weapon {
  ...
  SNARE_HOOK = 225,
  ATHAME_ARTIS = 226,
  LIGHTBEARING_MOONSHARD = 227,
  GEST_OF_THE_MIGHTY_WOLF = 228,
...
export function weaponFromJSON(object: any): Weapon {
  switch (object) {
    ...
    case 226:
    case "ATHAME_ARTIS":
      return Weapon.ATHAME_ARTIS;
    case 227:
    case "LIGHTBEARING_MOONSHARD":
      return Weapon.LIGHTBEARING_MOONSHARD;
    case 228:
    case "GEST_OF_THE_MIGHTY_WOLF":
      return Weapon.GEST_OF_THE_MIGHTY_WOLF;
    case 229:
    case "NOCTURNES_CURTAIN_CALL":
      return Weapon.NOCTURNES_CURTAIN_CALL;
    case 230:
    case "RAINBOW_SERPENTS_RAIN_BOW":
      return Weapon.RAINBOW_SERPENTS_RAIN_BOW;
    case 231:
...
export function weaponToJSON(object: Weapon): string {
  switch (object) {
    ...
    case Weapon.SNARE_HOOK:
      return "SNARE_HOOK";
    case Weapon.ATHAME_ARTIS:
      return "ATHAME_ARTIS";
    case Weapon.LIGHTBEARING_MOONSHARD:
      return "LIGHTBEARING_MOONSHARD";
    case Weapon.GEST_OF_THE_MIGHTY_WOLF:
      return "GEST_OF_THE_MIGHTY_WOLF";
    case Weapon.NOCTURNES_CURTAIN_CALL:
      return "NOCTURNES_CURTAIN_CALL";
    case Weapon.RAINBOW_SERPENTS_RAIN_BOW:
