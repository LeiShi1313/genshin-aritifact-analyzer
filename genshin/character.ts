...
export function characterFromJSON(object: any): Character {
  switch (object) {
    ...
    case 116:
    case "DURIN":
      return Character.DURIN;
    case 117:
    case "JAHODA":
      return Character.JAHODA;
    case 118:
    case "COLUMBINA":
      return Character.COLUMBINA;
    case 119:
    case "ZIBAI":
      return Character.ZIBAI;
    case 120:
    case "ILLUGA":
      return Character.ILLUGA;
    case 121:
    case "VARKA":
      return Character.VARKA;
    case 122:
    case "LOHEN":
      return Character.LOHEN;
    case 123:
    case "LINNEA":
      return Character.LINNEA;
    case 124:
    case "NICOLE":
      return Character.NICOLE;
    case 125:
    case "PRUNE":
      return Character.PRUNE;
    case 126:
    case "SANDRONE":
      return Character.SANDRONE;
    case 127:
    case "TRAVELER_CRYO":
      return Character.TRAVELER_CRYO;
    case 128:
    case "ALYOSHA":
      return Character.ALYOSHA;
    case 129:
    case "ODETTE":
      return Character.ODETTE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function characterToJSON(object: Character): string {
  switch (object) {
    ...
    case Character.NEFER:
      return "NEFER";
    case Character.DURIN:
      return "DURIN";
    case Character.JAHODA:
      return "JAHODA";
    case Character.COLUMBINA:
      return "COLUMBINA";
    case Character.ZIBAI:
      return "ZIBAI";
    case Character.ILLUGA:
      return "ILLUGA";
    case Character.VARKA:
      return "VARKA";
    case Character.LOHEN:
      return "LOHEN";
    case Character.LINNEA:
      return "LINNEA";
    case Character.NICOLE:
      return "NICOLE";
    case Character.PRUNE:
      return "PRUNE";
    case Character.SANDRONE:
      return "SANDRONE";
    case Character.TRAVELER_CRYO:
      return "TRAVELER_CRYO";
    case Character.ALYOSHA:
      return "ALYOSHA";
    case Character.ODETTE:
      return "ODETTE";
