...
import {
  ARTIFACT_SCORING_PERSIST_VERSION,
  artifactScoringMigrations,
} from "./migrations/artifactScoring";
...
const persistConfig = {
  ...
  storage: createIdbStorage({
    name: "genshin-artifact-builds",
    storeName: "redux",
  }),
  version: ARTIFACT_SCORING_PERSIST_VERSION,
